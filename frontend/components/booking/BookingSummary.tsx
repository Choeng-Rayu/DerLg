    ...
    <Card>
      ...
      <dl className="mt-4 grid gap-3 text-sm">
        <div className="flex justify-between gap-3">
          <dt className="text-[var(--color-foreground-muted)]">Reference</dt>
          <dd className="font-medium">{booking.bookingRef}</dd>
        </div>
        <div className="flex justify-between gap-3">
          <dt className="text-[var(--color-foreground-muted)]">Travel date</dt>
          <dd className="font-medium">{formatDate(booking.travelDate)}</dd>
        </div>
        <div className="flex justify-between gap-3">
          <dt className="text-[var(--color-foreground-muted)]">Total</dt>
          <dd className="font-medium">{formatCurrency(booking.totalUsd)}</dd>
        </div>
        <div className="flex justify-between gap-3">
          <dt className="text-[var(--color-foreground-muted)]">Status</dt>
